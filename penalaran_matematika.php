	...
	<body>
      ...
      require_once "dbconfig.php";
        ...
        <?php
            ...
            $query    = mysqli_query($koneksi, "SELECT * FROM penalaran_matematika ORDER BY RAND()");
            	...
            	$score1   = 0;
                  ...
                  for($i=0;$i<$jumlah;$i++){
                      ...
                      // jika memilih
                          ...
                          $query1  = mysqli_query($koneksi, "SELECT * FROM literasi_inggris WHERE id='$nomor' AND jawaban='$jawaban' and bobot=30");
                          ...
                          $query3  = mysqli_query($koneksi, "SELECT * FROM literasi_inggris WHERE id='$nomor' AND jawaban='$jawaban' and bobot=80");
