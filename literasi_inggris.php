            	...
            	$score1   = 0;
                  ...
                  for($i=0;$i<$jumlah;$i++){
                      ...
                      // jika memilih
                          ...
                          $query1  = mysqli_query($koneksi, "SELECT * FROM literasi_indonesia WHERE id='$nomor' AND jawaban='$jawaban' and bobot=25");
                          ...
                          $query3  = mysqli_query($koneksi, "SELECT * FROM literasi_indonesia WHERE id='$nomor' AND jawaban='$jawaban' and bobot=35");
