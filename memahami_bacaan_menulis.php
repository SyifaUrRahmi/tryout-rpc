            	...
            	$score1   = 0;
                  ...
                  for($i=0;$i<$jumlah;$i++){
                      ...
                      // jika memilih
                          ...
                          $query1  = mysqli_query($koneksi, "SELECT * FROM pengetahuan_pemahaman WHERE id='$nomor' AND jawaban='$jawaban' and bobot=40");
                          ...
                          $query2  = mysqli_query($koneksi, "SELECT * FROM pengetahuan_pemahaman WHERE id='$nomor' AND jawaban='$jawaban' and bobot=60");
