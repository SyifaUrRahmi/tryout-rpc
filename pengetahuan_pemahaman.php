            	...
            	$score1   = 0;
                  ...
                  for($i=0;$i<$jumlah;$i++){
                      ...
                      // jika memilih
                          ...
                          $query2  = mysqli_query($koneksi, "SELECT * FROM penalaran_umum WHERE id='$nomor' AND jawaban='$jawaban' and bobot=30");
                          ...
                          $query3  = mysqli_query($koneksi, "SELECT * FROM penalaran_umum WHERE id='$nomor' AND jawaban='$jawaban' and bobot=35");
                          ...
                          $query4  = mysqli_query($koneksi, "SELECT * FROM penalaran_umum WHERE id='$nomor' AND jawaban='$jawaban' and bobot=50");
                      ...
                      $hasil = $score1 + $score2 + $score3 + $score4; 
